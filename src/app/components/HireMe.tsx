...
const HireMe = () => {
  ...
  return (
    <div className="h-screen font-main bg-slate-50 text-slate-800 dark:bg-slate-900 dark:text-white flex flex-col items-center justify-center cursor-default w-screen">
      <div className="grid grid-cols-1 sm:grid-cols-[1fr_2fr] gap-4 h-3/6 lg:text-4xl md:text-2xl text-base font-bold">
        ...
        <span className="md:text-left">
          ...
          >
            {t("hire_me.click_here")}
          </a>
        </span>

        <span className="md:text-right"> {t("hire_me.linked_in")}:</span>
        <span className="md:text-left">
          <a
        ...
        <span className="md:text-right"> {t("hire_me.email")}:</span>
        <span className="md:text-left">
          <span
      ...
      <Toaster position="bottom-left" richColors theme={theme} />
    </div>
  );
};
