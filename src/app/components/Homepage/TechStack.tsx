...
const libraries = [
  ...
  {
    icon: <SiAntdesign className="h-full" />,
    name: "Ant Design",
    lightClass: "text-light-antd",
    darkClass: "text-dark-antd",
  },
  {
    icon: <SiShadcnui className="h-full" />,
    name: "Shadcn UI",
    lightClass: "text-light-shadcn",
    darkClass: "text-white",
  },
  {
    icon: <SiMui className="h-full" />,
    name: "Material UI",
  ...
  return (
    <div className="flex lg:gap-8 sm:gap-4 justify-around lg:justify-normal sm:justify-center w-full flex-wrap px-1 sm:px-0">
      {techStack.map((tech, index) => (
        <div
          key={index}
          className={`hover:scale-110 transition-all duration-150 ease-linear h-14 ${tech.lightClass} dark:${tech.darkClass}`}
        >
          <Tooltip
            title={tech.name}
            arrow={false}
  ...
  return (
    <div className="flex lg:gap-8 sm:gap-4 justify-around lg:justify-normal sm:justify-center w-full flex-wrap px-1 sm:px-0">
      {libraries.map((library, index) => (
        <div
          key={index}
          className={`hover:scale-110 transition-all duration-150 ease-linear h-14 ${library.lightClass} dark:${library.darkClass}`}
        >
          <Tooltip
            title={library.name}
            arrow={false}
