...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:px-10 px-2 flex flex-col lg:text-xl md:text-base text-sm text-center h-[88%] gap-6">
        <div
          data-aos="fade-right"
          className="flex w-full justify-center items-center max-h-[16vh]"
        >
          <span className="lg:w-7/12">
            Hi! I'm {age} years old and based in Milano, Italy. I'm passionate
